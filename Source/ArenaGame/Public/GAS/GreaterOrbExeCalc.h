...
#include "GreaterOrbExeCalc.generated.h"

/**
 * 
 */
UCLASS()
class ARENAGAME_API UGreaterOrbExeCalc : public UGameplayEffectExecutionCalculation
{
...

{
	...
	TargetCaptureAttribute()
	{
		...
		DEFINE_ATTRIBUTE_CAPTUREDEF(UGASAttributeSet, AppliedShield, Target,true);
	}
	
};

struct GASourceAttributeCapture
{
	DECLARE_ATTRIBUTE_CAPTUREDEF(Health);
